...
const Add = ({token}) => {
  ...
  const onSubmitHandler = async (e) =>{
    ...
    try {
      ...
      const response = await axios.post(backend_url + '/api/products/add', formData, {headers: {token}})
      ...
      console.error(error)
      toast.error('An error occurred while trying to add the product. Please try again.');
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e)=>(setSubCategory(e.target.value))} className='w-full px-3 py-2'>
            <option value="Topweare">Topwear</option>
